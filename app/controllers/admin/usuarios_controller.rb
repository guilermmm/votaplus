class Admin::UsuariosController < AdminController
  ...
  # GET /usuarios
  def index
    @usuarios = Usuario.all unless request.format.in?(%w[html js])
  ...
  def create
    ...
    respond_to do |format|
      if @usuario.save
        ...
        format.html { redirect_to remote.blank? ? location : admin_usuarios_path, notice: }
